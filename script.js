...
(function initPortfolioFilter() {
  ...
  // We can't pull hidden items out of layout easily without
  // absolute positioning. Instead we use a CSS class + opacity/scale.
  // But for grid reflow we'll toggle display via a small trick:
  // hide items with opacity+pointer-events, shrink them with max-height.
...
(function initContactForm() {
  ...
  form.addEventListener('submit', async e => {
    ...
    // Simulate async submission (replace with real fetch/formspree/etc.)
